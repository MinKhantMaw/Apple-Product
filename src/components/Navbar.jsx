...
const Navbar = ({ activePage, handleNavClick, isNavOpen, toggleNavBar }) => {
  return (
    <>
      <div
        className={`2xl:w-80 xl:w-52 w-44 h-full bg-[#f8f8f8] flex flex-col justify-between pt-5 pl-6 pb-14 md:pb-0 absolute md:relative z-10 ${
          isNavOpen ? "translate-x-0" : "-translate-x-110 md:translate-x-0"
