          ...
          <div className="w-60 h-[430px] flex flex-col justify-around group">
            ...
            >
              <img
                src={watch.imgs[0]}
                alt="Watch"
                className="absolute w-full h-full object-contain opacity-100 group-hover:opacity-0 transittion duration-300"
              />
              <img
                src={watch.imgs[1]}
                alt="Watch"
                className="absolute w-full h-full object-contain opacity-0 group-hover:opacity-100 transittion duration-300"
              />
            </div>
            ...
            <button
              type="button"
              className="w-min text-sm mt-4 py-1 px-2 rounded-full bg-blue-400 text-white"
            >
              Shop
            </button>
          </div>
