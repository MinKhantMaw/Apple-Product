...
const IMac = () => {
  ...
  return (
    <div className="grid grid-cols-2 grid-rows-2 md:gap-4 gap-1 bg-white relative">
      ...
      <div className="absolute md:top-1/2 top-3/4 md:left4 left-12 transform -translate-y-1/2 flex flex-col lg:space-y-1 space-y-1 bg-gray-50">
        ...
        <button
          type="button"
          className="text-sm mt-4 w-min py-1 px-2 bg-blue rounded-full text-white"
        >
          Shop
        </button>
      </div>
